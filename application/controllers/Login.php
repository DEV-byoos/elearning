...
class Login extends CI_Controller {
    ...
    function logins(){
        //echo "string";
        // echo ;
        $login_status = $this->validate_login($this->input->post('user'), sha1( $this->input->post('password')), $this->input->post('roleuser'));
        // echo  $login_status;
    ...
    function validate_login($email = '', $password = '', $roleuser = '') {
