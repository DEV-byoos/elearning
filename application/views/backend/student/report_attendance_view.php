                ...
                <tbody>
                        <tr>
                            ...
                            for ($i = 1; $i <= $days; $i++) {
                                ...
                                $attendance = $this->db->get_where('attendance', array('section_id' => $section_id, 'class_id' => $class_id, 'year' => $running_year, 'student_id' => $this->session->userdata('login_user_id')))->result_array();
