    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?teacher/homework/create/'.$lesson, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                            <input type="text" class="form-control mydatepicker" name="time_end"  value="" id="time_end">
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Subject'); ?></label>
                            <div class="col-sm-8">
                                <select name="subject_id" class="form-control" id="subject_selector_holder" onchange="get_class_lesson(this.value); ">
                ...
                <!-- <div class="form-group">
                    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Lesson'); ?></label>
                    <div class="col-sm-8">
                        <select name="lesson_id" class="form-control" id="lesson_selector_holder">
                            <option value=""><?php echo get_phrase('Select-Lessons'); ?></option>
                        </select>
                    </div>
                </div> -->
...
<script type="text/javascript">
    function get_class_lesson(subject_id) {
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?teacher/get_class_lesson/' + subject_id,
            success: function (response)
            {
                jQuery('#lesson_selector_holder').html(response);
            }
        });
        // console.log('haha');
    }
