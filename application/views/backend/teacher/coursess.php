		...
		<div class="tab-pane box active" id="list">
          <div class="white-box">
            ...
            <table id="myTable" class="table table-striped">
             ...
             <?php $edit_data      =   $this->db->get_where('lesson' , array('id_subject' => $row['subject_id']) )->result_array(); ?>
            ...
            <?php if (count($edit_data)==0) {?>
              <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_subject/<?php echo $row['subject_id'];?>');" data-toggle="tooltip" data-original-title="Subject Activity"> <i class="fa fa-plus-square-o text-info m-r-10"></i> </a>
            <?php }else {?>
              <a href="<?php echo base_url(); ?>index.php?teacher/lesson_list/<?php echo $row['subject_id'];?>" data-toggle="tooltip" data-original-title="Subject Activity"> <i class="fa fa-pencil text-info m-r-10"></i> </a>
              <?php } ?>
          </td>
                </tr>
                 <?php } ?>
